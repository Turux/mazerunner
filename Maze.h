...
class Maze
{
    public:
        ...
        virtual void UpdateRobotLocs(const vector<point>& vp) = 0; // copy points in vp to _robotLocs
...
inline ostream& operator << (ostream& os, const Maze& M)
{
    return M.Display(os) ;
}
